...
This Privacy Policy explains how **Infinite Wisdom Software** ("**Tao**", "**we**", "**us**") collects, uses, shares and protects personal data when you access or use the Tao Service, the website at [yaoagents.com](https://yaoagents.com), the console, and related APIs (the "**Service**"). It should be read together with our [Terms of Service](/docs/ja/terms/service) (the "**Terms**"). Capitalised terms not defined here have the meaning given in the Terms.
